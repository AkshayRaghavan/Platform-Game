...
GameObject::GameObject(InputComponent *input_component, GraphicsComponent *graphics_component, Keys input_keys, const int &max_jump_count) : keys(input_keys), maxJumpCount(max_jump_count)
{
